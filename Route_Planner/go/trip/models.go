...
type TripsRequest struct {
	Starting_from_location_id int   `json:"start" bson:"starting_from_location_id"`
	Location_ids              []int `json:"others" bson:"location_ids"`
	Ending_location_id 		  int   `json:"end" bson:"ending_location_id"`
}
...
type Plan struct {
	...
	Best_route_location_ids      []int   `json:"best_route_by_costs" bson:"best_route_location_ids"`
...
func (t *TripsResponse) prepareResponse(plan Plan) {
	...
	t.Ending_location_id = plan.Ending_location_id
