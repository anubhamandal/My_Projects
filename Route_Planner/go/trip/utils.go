...
func find_shortest_path(start_location, end_location Location, destinations []Location) []UberEstimate {
	...
	go fetchRoute(best_path[len(best_path)-1].Destination, end_location, messages)
	estimate := <-messages
